        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 7:
              ...
              res.status(500).json({
                msg: 'Error al extraer las categorias'
              });
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.prev = 0;
              _context2.next = 3;
              return _Category.Category.getOnebyId(req.params.id);
            ...
            case 7:
              ...
              res.status(500).json({
                msg: 'Error al extraer la categoria'
              });
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              _context3.prev = 0;
              _context3.next = 3;
              return _Category.Category.postOne(req.body);
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              _context4.prev = 0;
              _context4.next = 3;
              return _Category.Category.updateOne(req.params.id, req.body);
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              _context5.prev = 0;
              _context5.next = 3;
              return _Category.Category.deleteOne(req.params.id);
