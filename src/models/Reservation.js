...
export const Reservation = {
  ...
  getQrCodeByIds: (id_evento, id_usuario) => {
    return knex.select('codigo_qr').table('usuarios_eventos_reservan').where({ id_evento: id_evento }).where('id_usuario', id_usuario).where('esta_activo', 1)
  },
